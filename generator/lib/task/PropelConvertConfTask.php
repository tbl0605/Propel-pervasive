...
class PropelConvertConfTask extends AbstractPropelDataModelTask
{
    ...
    public function main()
    {
        ...
        $output = "<?php\n";
        $output .= "// This file generated by Propel " . $phpconf['generator_version'] . " convert-conf target" . ($this->getGeneratorConfig()->getBuildProperty('addTimestamp') ? " on " . datefmt_format(new IntlDateFormatter('en_US', null, null, null, null, 'ccc LLL d HH:mm:ss YYYY'), new DateTime()) : '') . "\n";
